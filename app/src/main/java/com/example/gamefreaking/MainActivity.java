package com.example.gamefreaking;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void intView(){
        ...
        btnNewGame = findViewById(R.id.buttonReset);
    ...
    private void playGame(boolean ketQua  ){
        ...
        int saiso =0;
        numberPhepTinh = random.nextInt(4);
        // 0=+ , 1 = -, 2 = * , 3 = /
    ...
    private class MyThread extends Thread{
        ...
        public void run() {
            ...
            diem =diem-1;
            //tvPoint.setText("Diem sau khi bi tru la :" + diem);
        }
    }
}
